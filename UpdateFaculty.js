        ...
        render()
        {
            var comp = null;
                    ...
                    switch(this.props.c)
                    {
                       ...
                       <li>{d.degree}<ul>
                        {d.courses.map( c =><li>{c} <ul className="update"><li> <a href="#"  ><h4>Add</h4></a></li><li><a href="#"  ><h4>Delete</h4></a></li></ul>  </li>)}</ul></li>)
                        break;
                        default:
                        comp = this.props.f.map(ff => <li>{ff} <ul className="update"> <li><a href="#"  ><h4>Add</h4></a></li> <li><a href="#"  ><h4>Delete</h4></a></li></ul></li>)
                    }
